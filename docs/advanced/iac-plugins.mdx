...
For a complete example, see the [Local Docker Datacenter](/guides/datacenters/local-docker) guide.
...
<CardGroup cols={2}>
  ...
  <Card title="Local Docker Datacenter" icon="docker" href="/guides/datacenters/local-docker">
