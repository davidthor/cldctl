...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/gcp-vms/`](https://github.com/davidthor/cldctl/tree/main/official-templates/gcp-vms)
</Info>
...
cldctl dc build . -t ghcr.io/myorg/gcp-vms-dc:v1.0.0
cldctl dc push ghcr.io/myorg/gcp-vms-dc:v1.0.0

# Deploy with variables
cldctl dc deploy gcp-vms-production \
...
cldctl env create staging --datacenter gcp-vms-production
