...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/gcp-cloud-run/`](https://github.com/architect-io/arcctl/tree/main/official-templates/gcp-cloud-run)
</Info>
...
# Serverless VPC connector (Cloud Run → Cloud SQL / Memorystore)
...
arcctl dc build . -t ghcr.io/myorg/gcp-cloud-run-dc:v1.0.0
arcctl dc push ghcr.io/myorg/gcp-cloud-run-dc:v1.0.0

# Deploy with variables
arcctl dc deploy gcp-production \
...
arcctl env create staging --datacenter gcp-production
