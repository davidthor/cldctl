...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/aws-lambda/`](https://github.com/architect-io/arcctl/tree/main/official-templates/aws-lambda)
</Info>
...
### Ingress Hook (API Gateway + CloudFront)
...
arcctl dc build . -t ghcr.io/myorg/aws-lambda-dc:v1.0.0
arcctl dc push ghcr.io/myorg/aws-lambda-dc:v1.0.0
