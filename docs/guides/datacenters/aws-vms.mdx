...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/aws-vms/`](https://github.com/architect-io/arcctl/tree/main/official-templates/aws-vms)
</Info>
...
arcctl dc build . -t ghcr.io/myorg/aws-vms-dc:v1.0.0
arcctl dc push ghcr.io/myorg/aws-vms-dc:v1.0.0
