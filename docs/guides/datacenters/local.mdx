...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/local/`](https://github.com/architect-io/arcctl/tree/main/official-templates/local)
</Info>
...
# Or set as default
export ARCCTL_DATACENTER=local
arcctl up
```
...
arcctl dc deploy local-dev ./local
...
arcctl logs -e my-env

# Stream logs from a specific component
arcctl logs -e my-env my-app -f

# View logs from a specific deployment
arcctl logs -e my-env my-app/deployment/api

# Open the Grafana dashboard
arcctl observability dashboard -e my-env
```
