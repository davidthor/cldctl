...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/aws-k8s/`](https://github.com/davidthor/cldctl/tree/main/official-templates/aws-k8s)
</Info>
...
- **Email**: AWS SES (SMTP)
- **Routing**: AWS ALB via Load Balancer Controller
...
Uses the AWS Load Balancer Controller for Kubernetes-native ALB routing:
...
cldctl dc build . -t ghcr.io/myorg/aws-k8s-dc:v1.0.0
cldctl dc push ghcr.io/myorg/aws-k8s-dc:v1.0.0
