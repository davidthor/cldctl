...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/do-vms/`](https://github.com/davidthor/cldctl/tree/main/official-templates/do-vms)
</Info>
...
- **Functions** are not natively serverless on VMs — they run as persistent processes behind Caddy reverse proxy on a dedicated Droplet
