...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/startup/`](https://github.com/davidthor/cldctl/tree/main/official-templates/startup)
</Info>
...
route {
  ...
  outputs = {
    ...
    hosts    = module.vercel_route.hosts
    protocol = "https"
...
cldctl dc build . -t ghcr.io/myorg/startup-dc:v1.0.0
cldctl dc push ghcr.io/myorg/startup-dc:v1.0.0
...
cldctl deploy ghcr.io/myorg/my-app:v1.0.0 -e production
