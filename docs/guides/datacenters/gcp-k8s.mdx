...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/gcp-k8s/`](https://github.com/architect-io/arcctl/tree/main/official-templates/gcp-k8s)
</Info>
...
arcctl dc build . -t ghcr.io/myorg/gcp-k8s-dc:v1.0.0
arcctl dc push ghcr.io/myorg/gcp-k8s-dc:v1.0.0

# Deploy with variables
arcctl dc deploy gcp-k8s-production \
...
arcctl env create staging --datacenter gcp-k8s-production
