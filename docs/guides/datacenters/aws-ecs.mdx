...
The EC2 VM module translates the portable `runtime` inputs into cloud-specific provisioning: selecting an AMI, installing the language runtime, system packages, running setup commands, and creating a systemd service.
