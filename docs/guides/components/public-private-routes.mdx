...
```bash
arcctl component build . -t ghcr.io/myorg/nextjs-with-admin:v1.0.0
arcctl component push ghcr.io/myorg/nextjs-with-admin:v1.0.0

arcctl deploy ghcr.io/myorg/nextjs-with-admin:v1.0.0 -e production \
