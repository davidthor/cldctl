...
```bash
# Build and push
arcctl component build . -t ghcr.io/myorg/nextjs-app:v1.0.0
arcctl component push ghcr.io/myorg/nextjs-app:v1.0.0

# Deploy
arcctl deploy ghcr.io/myorg/nextjs-app:v1.0.0 -e production \
  --var log_level=warn
```
...
<CardGroup cols={2}>
  ...
  <Card title="Vercel Datacenter" href="/guides/datacenters/vercel-functions">
    Deploy to Vercel
  </Card>
</CardGroup>
