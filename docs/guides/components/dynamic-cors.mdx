...
```bash
# Deploy API
cldctl deploy ghcr.io/myorg/api-with-cors:v1.0.0 -e staging \
  --var jwt_secret=$JWT_SECRET

# Deploy frontend (automatically links to API)
cldctl deploy ghcr.io/myorg/frontend-app:v1.0.0 -e staging
```

When the frontend deploys, cldctl:
