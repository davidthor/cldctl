...
When your component declares dependencies on other components, `arcctl up` will automatically pull and deploy any that are not already present in the environment. Dependencies are resolved transitively.
